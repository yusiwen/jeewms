...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="baCostList" checkbox="true" pagination="true" fitColumns="false" title="费用名称" actionUrl="baCostController.do?datagrid" idField="id" fit="true" queryMode="group">
