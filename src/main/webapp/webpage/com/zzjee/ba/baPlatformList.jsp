...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="baPlatformList" checkbox="true" pagination="true" fitColumns="false" title="月台主数据" actionUrl="baPlatformController.do?datagrid" idField="id" fit="true" queryMode="group">
