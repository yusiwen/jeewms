...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmImNoticeHList" checkbox="true" fitColumns="false" title="进货通知抬头(默认显示前后7天数据)" actionUrl="wmImNoticeHController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="司机"  field="imCarDri"   query="true" queryMode="single"  width="70"></t:dgCol>
   <t:dgCol title="司机电话"  field="imCarMobile"   query="true" queryMode="single"  width="120"></t:dgCol>
