...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmImNoticeHList" checkbox="true" fitColumns="false" title="其他出入库" actionUrl="wmImNoticeHController.do?datagridqt" idField="id" fit="true" queryMode="group">
   ...
   <t:dgConfOpt title="删除" url="wmImNoticeHController.do?doDel&id={id}"  urlclass="ace_button" message="确定要删除此退货通知" urlfont="fa-trash-o" exp="imSta#eq#计划中"/>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="wmImNoticeHController.do?goAdd&orderTypeCode=09" funname="add" width="100%" height="100%"></t:dgToolBar>
