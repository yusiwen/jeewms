...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmImNoticeHList" checkbox="true" fitColumns="false" title="退货通知" actionUrl="wmImNoticeHController.do?datagridt" idField="id" fit="true" queryMode="group">
