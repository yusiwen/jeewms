...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmSttInGoodsList" checkbox="true" pagination="true" fitColumns="false" title="库存盘点" actionUrl="wmSttInGoodsController.do?datagrid" idField="id" fit="true" queryMode="group">
